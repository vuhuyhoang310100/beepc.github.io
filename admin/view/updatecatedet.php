        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end">
                ...
                for ($j  = 1; $j <= $trang; $j++) {
                    if (isset($_GET['id'])) {
                ?>
                        <li class="page-item"><a class="page-link" href="index.php?admin=updatecatedet&id=<?php echo $id ?>&page=<?php echo $j ?>"><?php echo $j; ?></a>
                        </li>
                    <?php
                    } else {
                    ?>
                        <li class="page-item"><a class="page-link" href="index.php?admin=updatecatedet&page=<?php echo $j ?>"><?php echo $j ?></a>
                        </li>
                <?php
                    }
                }
