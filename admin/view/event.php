    ...
    <div class="d-flex justify-content-between">
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-end">
                ...
                ?>
                        <li class="page-item <?php echo $activeClass; ?>"><a class="page-link" href="index.php?admin=event&id=<?php echo $id ?>&page=<?php echo $j ?>"><?php echo $j; ?></a>
                        </li>
                    <?php
                    } else {
                    ?>
                        <li class="page-item <?php echo $activeClass; ?>"><a class="page-link" href="index.php?admin=event&page=<?php echo $j ?>"><?php echo $j ?></a>
                        </li>
                <?php
                    }
                }
