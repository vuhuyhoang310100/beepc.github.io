...
if (isset($_POST['register']) && $_POST['register']) {
    ...
    if ($newuser->adduser($_POST['username'], md5($_POST['password']), $_POST['email']) == true) {
        $_SESSION['stt'] = "Đăng ký thành công !!!";
        header("Location: login.php");
        exit();
    } else {
        header("Location: register.php");
        $_SESSION['stt'] = "Đăng ký không thành công !!!";
    }
}
?>
<!doctype html>
                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    <form class="mx-1 mx-md-4" action="" method="post">
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <input type="submit" value="Register" name="register" class="btn btn-success btn-lg text-light my-2 py-3" style="width:100% ; border-radius: 30px; font-weight:600;" style="border-radius:25px ;" />

                                        </div>

                                    </form>
                                    <p align="center">Tôi đã có tài khoản <a href="login.php" class="text-danger" style="font-weight:600; text-decoration:none;">Đăng nhập</a></p>
                                </div>
                                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">

                                    <img src="../public/asset/img/istockphoto-1184363036-612x612.jpg    " class="img-fluid" alt="Sample image" height="300px" width="500px">
