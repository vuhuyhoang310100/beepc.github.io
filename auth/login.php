        ...
        <div class="container py-5 h-100">
            <div class="row d-flex align-items-center justify-content-center h-100">
                <div class="col-md-8 col-lg-7 col-xl-6">
                    <img src="../public/asset/img/privacy-banner-full.png_103014959.png" class="img-fluid"
                        alt="Phone image" height="300px" width="600px">
                </div>
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="form-outline mb-1">
                            ...
                            <input type="email" id="form1Example13" class="form-control form-control-lg py-3"
                                name="email" autocomplete="off" placeholder="Nhập email..."
                        ...
                        <div class="form-outline mb-4 mt-0">
                            ...
                            <input type="password" id="form1Example23" class="form-control form-control-lg py-3"
                                name="password" autocomplete="off" placeholder="Nhập mật khẩu..."
                                style="border-radius:25px ;" />
                        </div>
                        <!-- Submit button -->
                    ...
                    <p align="center">Tôi chưa có tài khoản <a href="register.php" class="text-danger"
